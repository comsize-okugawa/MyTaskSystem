<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="java.util.List,model.entity.UserStatusCategoryTaskBean, java.time.LocalDate"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<table border=1>
		...
		<tr>
			...
			<td>
				<%
				LocalDate limitDate = LocalDate.of(2025, 01, 01);
				
				if (list.getLimitDate().isEqual(limitDate)) {
					%>-<%
			...
			<td>
				<form action="judge-user-edit-servlet" method="POST">
					<input type="hidden" name="taskUserId"
						value="<%=list.getUserId()%>"> <input type="hidden"
						name="taskId" value="<%=list.getTaskId()%>"> <input
						type="submit" name="edit" value="編集">
				</form>
			</td>
		</tr>
